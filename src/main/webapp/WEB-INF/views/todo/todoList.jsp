		...
		<tbody>
		    <c:forEach items="${todoList }" var="todo">
		    	<tr>
		    		<td>${todo.no }</td>
		    		<td>
		    			<input type="checkbox" name="completeCheckbox" value="${todo.no}" ${not empty todo.completedAt ? 'checked' : ""}/> 
		    		</td>
		    		<td>${todo.todo }</td>
		    		<td>
...
<form action="${pageContext.request.contextPath }/todo/updateTodo.do"
